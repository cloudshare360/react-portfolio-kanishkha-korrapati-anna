...
function App() {
  ...
  return <div className="site-shell">
    ...
    <main id="top">
      ...
      </div><aside className="hero-card"><div className="availability"><i />Open to finance & analytics roles</div><img className="profile-photo" src={`${process.env.PUBLIC_URL}/images/kanishka.png`} alt="Kanishkha Korrapati Anna" /><div><strong>Based in California</strong><p>Eligible to work in the U.S. on OPT; no sponsorship required for initial employment.</p></div></aside></div>
