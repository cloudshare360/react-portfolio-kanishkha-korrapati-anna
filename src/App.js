...
function App() {
  ...
  return <div className="site-shell">
    <header className="nav-wrap"><nav className="nav container" aria-label="Primary navigation">
      ...
      <div className={`nav-links ${menuOpen ? 'open' : ''}`}><a href="#experience" onClick={closeMenu}>Experience</a><a href="#expertise" onClick={closeMenu}>Expertise</a><a href="#education" onClick={closeMenu}>Education</a><a className="nav-cta" href="#contact" onClick={closeMenu}>Let’s talk</a></div>
    </nav></header>
    <main id="top">
      <section className="hero container"><div className="eyebrow">Financial analysis · Investment research · Data analytics</div><div className="hero-grid"><div>
        ...
        <div className="actions"><a className="button primary" href="#experience">Explore my work</a><a className="button text" href="Kanishkha_Korrapati_Anna_Resume_2026.pdf" target="_blank" rel="noreferrer">View résumé ↗</a></div>
      </div><aside className="hero-card"><div className="availability"><i />Open to finance & analytics roles</div><div className="monogram">K<span>A</span></div><div><strong>Based in California</strong><p>Eligible to work in the U.S. on OPT; no sponsorship required for initial employment.</p></div></aside></div>
